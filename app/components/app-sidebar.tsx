...
export function AppSidebar() {
    ...
    return (
        <Sidebar collapsible="none" className="border-r border-sidebar-border h-screen bg-stone-950">
            ...
            <SidebarFooter className="p-4 ">
                {usage && (
                    <div className="rounded-lg bg-sidebar-accent/20 border p-3 mb-3">
                        <div className="flex text-xs font-medium text-sidebar-accent-foreground mb-3 gap-1">
                            Current Plan : 
                            <div className="text-blue-400 " > {usage.currentPlan.toUpperCase()} </div>
                        </div>
                ...
                {upgradeInfo && (
                    <div className="rounded-lg bg-sidebar-accent border p-3">
                        <div className="space-y-3">
                            <div className="space-y-1">
                                <p className="text-m font-medium text-blue-500">
                                    {upgradeInfo.title}
                                </p>
                            ...
                            {!upgradeInfo.showButton && (
                                <div className="text-center py-2">
                                    <span className="text-xs font-bold text-sidebar-accent-foreground/60 mr-2">🎉 Thank you for your support !</span>
                                </div>
                            )}
