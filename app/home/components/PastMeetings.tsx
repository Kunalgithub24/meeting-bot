    ...
    if (pastMeetings.length === 0) {
        return (
            <div className='bg-card rounded-lg p-8 text-center border border-border'>
                ...
                <p className='bg-linear-to-r from-gray-200 to-gray-400 bg-clip-text text-transparent '>Your completed meetings will appear here</p>
            </div>
        )
    }
        ...
        <div className='space-y-4'>
            {pastMeetings.map((meeting) => (
                ...
                >
                    ...
                    >
                        <Button
                            className='flex items-center px-3 py-3.5 bg-primary text-primary-foreground text-xs rounded hover:bg-primary/90 transition-colors h-6 cursor-pointer'
                            onClick={() => onMeetingClick(meeting.id)}
                        >
