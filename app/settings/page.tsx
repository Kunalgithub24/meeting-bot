        ...
        <div className='min-h-screen bg-background p-6'>
            <div className='max-w-2xl mx-auto'>
                ...
                <div className='relative bg-card/80 backdrop-blur-sm rounded-lg p-6 border border-border/50 mb-8 shadow-xl shadow-black/10'>
                    <div className='absolute inset-0 bg-linear-to-br from-white/5 to-transparent rounded-lg pointer-events-none'></div>
                    <div className='relative'>
                        <div className='flex items-center gap-4 mb-4'>
                            <div className='w-16 h-16 rounded-full shrink-0 overflow-hidden ring-2 ring-primary/20'>
                                {user?.imageUrl ? (
                                    <img
                                        src={user.imageUrl}
                                        alt="profile"
