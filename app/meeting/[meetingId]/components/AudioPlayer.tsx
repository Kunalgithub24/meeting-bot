...
function CustomAudioPlayer({
    ...
    return (
        <div
            className={`fixed bottom-0 bg-neutral-950 border-t border-border p-5 ${!isOwner
                ? 'left-0 right-0'
                : ''
                }`}
            style={isOwner ? { left: 'var(--sidebar-width, 16rem)', right: '25rem' } : {}}
        >
            ...
            <div className={!isOwner ? 'max-w-4xl mx-auto' : ''}>
                <div className='flex items-center gap-4'>
                    ...
                    <div className='flex-1 flex items-center gap-3'>
                        <span className='text-sm text-muted-foreground min-w-10px'>
